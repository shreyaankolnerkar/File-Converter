...
def derangements(iterable: Iterable[_T], r: int | None = None) -> Iterator[tuple[_T, ...]]: ...
...
def _sample_counted(population: Iterator[_T], k: int, counts: Iterable[int], strict: bool) -> list[_T]: ...
def _sample_weighted(iterator: Iterator[_T], k: int, weights: Iterator[float], strict: bool) -> list[_T]: ...
def sample(
    iterable: Iterable[_T],
    k: int,
...
def argmin(iterable: Iterable[_T], *, key: Callable[[_T], _U] | None = ...) -> int: ...
def argmax(iterable: Iterable[_T], *, key: Callable[[_T], _U] | None = ...) -> int: ...
def extract(iterable: Iterable[_T], indices: Iterable[int]) -> Iterator[_T]: ...
