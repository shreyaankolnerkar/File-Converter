...
class XmpInformation(PdfObject):
    ...
    def getElement(self, aboutUri: str, namespace: str, name: str) -> Iterator[Any]:  # pragma: no cover
        """
        .. deprecated:: 1.28.0
    ...
    def getNodesInNamespace(self, aboutUri: str, namespace: str) -> Iterator[Any]:  # pragma: no cover
        """
        .. deprecated:: 1.28.0
