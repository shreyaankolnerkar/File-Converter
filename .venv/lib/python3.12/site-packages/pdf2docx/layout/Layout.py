...
class Layout(Element, ABC):
    ...
    def store(self):
        ...
        res.update({"blocks": self.blocks.store(), "shapes": self.shapes.store()})
        return res
    ...
    def assign_shapes(self, shapes: list):
        ...
        for shape in shapes:
            if self.working_bbox.intersects(shape.bbox):
    ...
    def _parse_paragraph(self, **settings):
        ...
        self.blocks.parse_text_format(self.shapes.text_style_shapes, settings["delete_end_line_hyphen"])
