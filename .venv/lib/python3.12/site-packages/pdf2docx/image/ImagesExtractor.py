...
from ..common.algorithm import inner_contours, recursive_xy_cut, xy_project_profile
...
class ImagesExtractor:
    ...
    def clip_page_to_pixmap(self, bbox: fitz.Rect = None, rm_image: bool = False, zoom: float = 3.0):
