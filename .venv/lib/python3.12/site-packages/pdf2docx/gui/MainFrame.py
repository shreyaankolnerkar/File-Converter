...
class MainFrame(Frame):
    ...
    def setup_ui(self):
        ...
        self.select_new_file_folder = Button(
            self,
            text="Select new files folder",
            fg="black",
            bg="white",
            border=3,
    ...
    def _callback_convert(self):
        ...
        if not self.pdf_paths and not self.docx_folder:
            messagebox.showwarning(
                ...
                message="Select PDF file or files for convert " "and Select a folder for the converted files!",
            )
            return
        ...
        if any([os.path.exists(path) for path in docx_paths]) and not messagebox.askokcancel(
            title="Existed target file",
