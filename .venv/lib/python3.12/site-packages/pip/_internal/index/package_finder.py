...
class CandidateEvaluator:
    ...
    def get_applicable_candidates(
        ...
        if self._release_control is not None:
            allow_prereleases = self._release_control.allows_prereleases(canonicalize_name(self._project_name))
        else:
        ...
        if select_backend().NAME == "pkg_resources":
            candidates_and_versions: list[tuple[InstallationCandidate, str | Version]] = [
