...
class ConfigOptionParser(CustomOptionParser):
    ...
    def _get_ordered_configuration_items(
        ...
        section_items_dict: dict[str, dict[str, Any]] = {name: {} for name in override_order}
        ...
        section_items = {name: [(k, v) for k, v in section_items_dict[name].items() if v] for name in override_order}
    ...
    def print_help(self, file: Any = None) -> None:
        ...
        console = PipConsole(theme=Theme(PrettyHelpFormatter.styles), no_color=no_color, file=file)
