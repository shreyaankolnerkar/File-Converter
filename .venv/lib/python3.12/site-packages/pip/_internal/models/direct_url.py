...
def _get(d: dict[str, Any], expected_type: type[T], key: str, default: T | None = None) -> T | None:
...
def _get_required(d: dict[str, Any], expected_type: type[T], key: str, default: T | None = None) -> T:
