...
class InprocessBuildEnvironmentInstaller:
    ...
    def install(
        ...
        *,
        ...
        try:
            ...
            logger.info("")
            raise BuildDependencyInstallError(for_req, requirements, cause=exc, log_lines=None)
            ...
            raise BuildDependencyInstallError(for_req, requirements, cause=exc, log_lines=logs)
    ...
    def _install_impl(self, requirements: Iterable[str], prefix: _Prefix) -> None:
        ...
        self._preparer.prepare_linked_requirements_more(resolved_set.requirements.values())
