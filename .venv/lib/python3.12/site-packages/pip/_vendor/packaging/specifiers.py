...
class Specifier(BaseSpecifier):
    ...
    def _compare_less_than(self, prospective: Version, spec_str: str) -> bool:
        ...
        if not spec.is_prerelease and prospective.is_prerelease and _base_version(prospective) == _base_version(spec):
            return False
    ...
    def _compare_greater_than(self, prospective: Version, spec_str: str) -> bool:
        ...
        if not spec.is_postrelease and prospective.is_postrelease and _base_version(prospective) == _base_version(spec):
            return False

        # Ensure that we do not allow a local version of the version mentioned
        # in the specifier, which is technically greater than, to match.
        if prospective.local is not None and _base_version(prospective) == _base_version(spec):
            return False
