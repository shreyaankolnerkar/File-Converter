...
class Blender:
    ...
    def prepare(
        self,
        corners: _typing.Sequence[cv2.typing.Point],
        sizes: _typing.Sequence[cv2.typing.Size],
    ) -> None: ...
    @_typing.overload
    ...
    @_typing.overload
    def blend(
        self, dst: cv2.typing.MatLike, dst_mask: cv2.typing.MatLike
...
class FeatherBlender(Blender):
    ...
    def createWeightMaps(
        self,
        masks: _typing.Sequence[cv2.UMat],
        corners: _typing.Sequence[cv2.typing.Point],
        weight_maps: _typing.Sequence[cv2.UMat],
    ) -> tuple[cv2.typing.Rect, _typing.Sequence[cv2.UMat]]: ...
...
class ExposureCompensator:
    ...
    def getMatGains(
        self, arg1: _typing.Sequence[cv2.typing.MatLike] | None = ...
...
class NoExposureCompensator(ExposureCompensator):
    ...
    def apply(
        self,
        arg1: int,
        arg2: cv2.typing.Point,
        arg3: cv2.typing.MatLike,
        arg4: cv2.typing.MatLike,
    ) -> cv2.typing.MatLike: ...
    @_typing.overload
    def apply(self, arg1: int, arg2: cv2.typing.Point, arg3: cv2.UMat, arg4: cv2.UMat) -> cv2.UMat: ...
    def getMatGains(
        self, umv: _typing.Sequence[cv2.typing.MatLike] | None = ...
    ) -> _typing.Sequence[cv2.typing.MatLike]: ...
...
class FeaturesMatcher:
    ...
    def apply2(
        self, features: _typing.Sequence[ImageFeatures], mask: cv2.UMat | None = ...
    ) -> _typing.Sequence[MatchesInfo]: ...
...
class Estimator:
    ...
    def apply(
        self,
        features: _typing.Sequence[ImageFeatures],
        pairwise_matches: _typing.Sequence[MatchesInfo],
        cameras: _typing.Sequence[CameraParams],
    ) -> tuple[bool, _typing.Sequence[CameraParams]]: ...
...
class NoSeamFinder(SeamFinder):
    ...
    def find(
        self,
        arg1: _typing.Sequence[cv2.UMat],
        arg2: _typing.Sequence[cv2.typing.Point],
        arg3: _typing.Sequence[cv2.UMat],
    ) -> _typing.Sequence[cv2.UMat]: ...
...
# Functions
def calibrateRotatingCamera(
    Hs: _typing.Sequence[cv2.typing.MatLike], K: cv2.typing.MatLike | None = ...
) -> tuple[bool, cv2.typing.MatLike]: ...
@_typing.overload
def computeImageFeatures(
    featuresFinder: cv2.Feature2D,
    images: _typing.Sequence[cv2.typing.MatLike],
    masks: _typing.Sequence[cv2.typing.MatLike] | None = ...,
) -> _typing.Sequence[ImageFeatures]: ...
@_typing.overload
def computeImageFeatures(
    featuresFinder: cv2.Feature2D,
    images: _typing.Sequence[cv2.UMat],
    masks: _typing.Sequence[cv2.UMat] | None = ...,
) -> _typing.Sequence[ImageFeatures]: ...
@_typing.overload
def computeImageFeatures2(
    featuresFinder: cv2.Feature2D,
    image: cv2.typing.MatLike,
...
@_typing.overload
def computeImageFeatures2(
    featuresFinder: cv2.Feature2D, image: cv2.UMat, mask: cv2.UMat | None = ...
) -> ImageFeatures: ...
@_typing.overload
def createLaplacePyr(
    img: cv2.typing.MatLike, num_levels: int, pyr: _typing.Sequence[cv2.UMat]
) -> _typing.Sequence[cv2.UMat]: ...
@_typing.overload
def createLaplacePyr(img: cv2.UMat, num_levels: int, pyr: _typing.Sequence[cv2.UMat]) -> _typing.Sequence[cv2.UMat]: ...
@_typing.overload
def createLaplacePyrGpu(
    img: cv2.typing.MatLike, num_levels: int, pyr: _typing.Sequence[cv2.UMat]
) -> _typing.Sequence[cv2.UMat]: ...
@_typing.overload
def createLaplacePyrGpu(
    img: cv2.UMat, num_levels: int, pyr: _typing.Sequence[cv2.UMat]
) -> _typing.Sequence[cv2.UMat]: ...
@_typing.overload
...
def matchesGraphAsString(
    paths: _typing.Sequence[str],
    pairwise_matches: _typing.Sequence[MatchesInfo],
    conf_threshold: float,
) -> str: ...
@_typing.overload
...
def overlapRoi(
    tl1: cv2.typing.Point,
    tl2: cv2.typing.Point,
    sz1: cv2.typing.Size,
    sz2: cv2.typing.Size,
    roi: cv2.typing.Rect,
) -> bool: ...
def restoreImageFromLaplacePyr(
    pyr: _typing.Sequence[cv2.UMat],
) -> _typing.Sequence[cv2.UMat]: ...
def restoreImageFromLaplacePyrGpu(
    pyr: _typing.Sequence[cv2.UMat],
) -> _typing.Sequence[cv2.UMat]: ...
@_typing.overload
...
def waveCorrect(
    rmats: _typing.Sequence[cv2.typing.MatLike], kind: WaveCorrectKind
) -> _typing.Sequence[cv2.typing.MatLike]: ...
