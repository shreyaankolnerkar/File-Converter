...
class Text:
    ...
    def __init__(
        self,
        text_: str,
        org_: cv2.typing.Point,
        ff_: int,
        fs_: float,
        color_: cv2.typing.Scalar,
        thick_: int = ...,
        lt_: int = ...,
...
class Line:
    ...
    def __init__(
        self,
        pt1_: cv2.typing.Point,
        pt2_: cv2.typing.Point,
        color_: cv2.typing.Scalar,
        thick_: int = ...,
        lt_: int = ...,
        shift_: int = ...,
...
class Image:
    ...
    def __init__(
        self,
        org_: cv2.typing.Point,
        img_: cv2.typing.MatLike,
        alpha_: cv2.typing.MatLike,
    ) -> None: ...
    @_typing.overload
    def __init__(self) -> None: ...
...
class Poly:
    ...
    def __init__(
        self,
        points_: _typing.Sequence[cv2.typing.Point],
        color_: cv2.typing.Scalar,
        thick_: int = ...,
        lt_: int = ...,
        shift_: int = ...,
...
def render(
    ...
    prims: _typing.Sequence[cv2.typing.Prim],
    args: _typing.Sequence[cv2.GCompileArg] = ...,
) -> None: ...
@_typing.overload
def render(
    y_plane: cv2.typing.MatLike,
    uv_plane: cv2.typing.MatLike,
    prims: _typing.Sequence[cv2.typing.Prim],
    args: _typing.Sequence[cv2.GCompileArg] = ...,
) -> None: ...
