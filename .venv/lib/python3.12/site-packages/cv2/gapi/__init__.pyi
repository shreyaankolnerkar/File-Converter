...
def kmeans(
    ...
    attempts: int,
    flags: cv2.KmeansFlags,
) -> tuple[cv2.GOpaqueT, cv2.GMat, cv2.GMat]: ...
@_typing.overload
def kmeans(
    data: cv2.GMat,
    K: int,
...
def kmeans(
    data: cv2.GArrayT,
    K: int,
    bestLabels: cv2.GArrayT,
    criteria: cv2.typing.TermCriteria,
    attempts: int,
    flags: cv2.KmeansFlags,
) -> tuple[cv2.GOpaqueT, cv2.GArrayT, cv2.GArrayT]: ...
@_typing.overload
def kmeans(
    data: cv2.GArrayT,
    K: int,
...
def parseSSD(
    ...
    filterLabel: int = ...,
) -> tuple[cv2.GArrayT, cv2.GArrayT]: ...
@_typing.overload
def parseSSD(
    in_: cv2.GMat,
    inSz: cv2.GOpaqueT,
    confidenceThreshold: float,
    alignmentToSquare: bool,
    filterOutOfBounds: bool,
) -> cv2.GArrayT: ...
def parseYolo(
    in_: cv2.GMat,
    inSz: cv2.GOpaqueT,
    confidenceThreshold: float = ...,
    nmsThreshold: float = ...,
    anchors: _typing.Sequence[float] = ...,
) -> tuple[cv2.GArrayT, cv2.GArrayT]: ...
