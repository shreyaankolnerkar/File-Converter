...
class GraphicalCodeDetector:
    ...
    @_typing.overload
    def detectAndDecodeBytes(
        self,
        img: cv2.typing.MatLike,
        points: cv2.typing.MatLike | None = ...,
        straight_code: cv2.typing.MatLike | None = ...,
    ) -> tuple[bytes, cv2.typing.MatLike, cv2.typing.MatLike]: ...
    @_typing.overload
    def detectAndDecodeBytes(
        self, img: UMat, points: UMat | None = ..., straight_code: UMat | None = ...
    ) -> tuple[bytes, UMat, UMat]: ...
    @_typing.overload
    def decodeBytes(
        self,
        img: cv2.typing.MatLike,
        points: cv2.typing.MatLike,
        straight_code: cv2.typing.MatLike | None = ...,
    ) -> tuple[bytes, cv2.typing.MatLike]: ...
    @_typing.overload
    def decodeBytes(self, img: UMat, points: UMat, straight_code: UMat | None = ...) -> tuple[bytes, UMat]: ...
    @_typing.overload
    def decodeBytesMulti(
        self,
        img: cv2.typing.MatLike,
        points: cv2.typing.MatLike,
        straight_code: _typing.Sequence[cv2.typing.MatLike] | None = ...,
    ) -> tuple[bool, _typing.Sequence[bytes], _typing.Sequence[cv2.typing.MatLike]]: ...
    @_typing.overload
    def decodeBytesMulti(
        self,
        img: UMat,
        points: UMat,
        straight_code: _typing.Sequence[UMat] | None = ...,
    ) -> tuple[bool, _typing.Sequence[bytes], _typing.Sequence[UMat]]: ...
    @_typing.overload
    def detectAndDecodeBytesMulti(
        self,
        img: cv2.typing.MatLike,
        points: cv2.typing.MatLike | None = ...,
        straight_code: _typing.Sequence[cv2.typing.MatLike] | None = ...,
    ...
    def detectAndDecodeBytesMulti(
        ...
        points: UMat | None = ...,
        straight_code: _typing.Sequence[UMat] | None = ...,
    ) -> tuple[bool, _typing.Sequence[bytes], UMat, _typing.Sequence[UMat]]: ...
...
class BackgroundSubtractor(Algorithm):
    ...
    def apply(
        self,
        image: cv2.typing.MatLike,
        knownForegroundMask: cv2.typing.MatLike,
        fgmask: cv2.typing.MatLike | None = ...,
        learningRate: float = ...,
    ) -> cv2.typing.MatLike: ...
    @_typing.overload
...
@_typing.overload
def HoughCirclesWithAccumulator(
    image: cv2.typing.MatLike,
    method: int,
    dp: float,
    minDist: float,
...
def calibrateCameraExtended(
    ...
    flags: int = ...,
    criteria: cv2.typing.TermCriteria = ...,
) -> tuple[float, UMat, UMat, _typing.Sequence[UMat], _typing.Sequence[UMat], UMat, UMat, UMat]: ...
@_typing.overload
...
) -> tuple[int, _typing.Sequence[UMat], _typing.Sequence[UMat], _typing.Sequence[UMat]]: ...
@_typing.overload
...
def estimateTranslation2D(
    ...
    confidence: float = ...,
    refineIters: int = ...,
) -> tuple[cv2.typing.Vec2d, cv2.typing.MatLike]: ...
@_typing.overload
def estimateTranslation2D(
    from_: UMat,
    to: UMat,
...
def findEssentialMat(
    ...
    distCoeffs1: cv2.typing.MatLike | None,
    cameraMatrix2: cv2.typing.MatLike,
    distCoeffs2: cv2.typing.MatLike | None,
    method: int = ...,
    prob: float = ...,
    threshold: float = ...,
    mask: cv2.typing.MatLike | None = ...,
...
def findEssentialMat(
    ...
    points2: UMat,
    cameraMatrix1: UMat,
    distCoeffs1: UMat | None,
    cameraMatrix2: UMat,
    distCoeffs2: UMat | None,
    method: int = ...,
    prob: float = ...,
    threshold: float = ...,
    mask: UMat | None = ...,
...
def findEssentialMat(
    ...
    cameraMatrix1: cv2.typing.MatLike,
    cameraMatrix2: cv2.typing.MatLike,
    dist_coeff1: cv2.typing.MatLike | None,
    dist_coeff2: cv2.typing.MatLike | None,
    params: UsacParams,
    mask: cv2.typing.MatLike | None = ...,
) -> tuple[cv2.typing.MatLike, cv2.typing.MatLike]: ...
@_typing.overload
def findEssentialMat(
    ...
    cameraMatrix1: UMat,
    cameraMatrix2: UMat,
    dist_coeff1: UMat | None,
    dist_coeff2: UMat | None,
    params: UsacParams,
    mask: UMat | None = ...,
) -> tuple[cv2.typing.MatLike, UMat]: ...
@_typing.overload
...
@_typing.overload
def findTransformECCWithMask(
    templateImage: cv2.typing.MatLike,
    inputImage: cv2.typing.MatLike,
    templateMask: cv2.typing.MatLike,
    inputMask: cv2.typing.MatLike,
    warpMatrix: cv2.typing.MatLike,
    motionType: int = ...,
    criteria: cv2.typing.TermCriteria = ...,
...
@_typing.overload
def getClosestEllipsePoints(
    ellipse_params: cv2.typing.RotatedRect,
    points: cv2.typing.MatLike,
    closest_pts: cv2.typing.MatLike | None = ...,
) -> cv2.typing.MatLike: ...
@_typing.overload
def getClosestEllipsePoints(
    ellipse_params: cv2.typing.RotatedRect, points: UMat, closest_pts: UMat | None = ...
) -> UMat: ...
...
@_typing.overload
def imdecodeWithMetadata(
    buf: cv2.typing.MatLike,
    metadata: _typing.Sequence[cv2.typing.MatLike] | None = ...,
    flags: int = ...,
) -> tuple[cv2.typing.MatLike, _typing.Sequence[int], _typing.Sequence[cv2.typing.MatLike]]: ...
@_typing.overload
def imdecodeWithMetadata(
    buf: UMat, metadata: _typing.Sequence[UMat] | None = ..., flags: int = ...
) -> tuple[cv2.typing.MatLike, _typing.Sequence[int], _typing.Sequence[UMat]]: ...
@_typing.overload
...
@_typing.overload
def imencodeWithMetadata(
    ext: str,
    img: cv2.typing.MatLike,
    metadataTypes: _typing.Sequence[int],
    metadata: _typing.Sequence[cv2.typing.MatLike],
    params: _typing.Sequence[int] = ...,
) -> tuple[bool, numpy.ndarray[_typing.Any, numpy.dtype[numpy.uint8]]]: ...
@_typing.overload
def imencodeWithMetadata(
    ...
    img: UMat,
    metadataTypes: _typing.Sequence[int],
    metadata: _typing.Sequence[UMat],
    params: _typing.Sequence[int] = ...,
) -> tuple[bool, numpy.ndarray[_typing.Any, numpy.dtype[numpy.uint8]]]: ...
def imencodeanimation(
    ext: str, animation: Animation, params: _typing.Sequence[int] = ...
) -> tuple[bool, numpy.ndarray[_typing.Any, numpy.dtype[numpy.uint8]]]: ...
@_typing.overload
def imencodemulti(
    ext: str,
...
def imreadWithMetadata(
    filename: str | os.PathLike[str],
    metadata: _typing.Sequence[UMat] | None = ...,
    flags: int = ...,
) -> tuple[cv2.typing.MatLike, _typing.Sequence[int], _typing.Sequence[UMat]]: ...
...
@_typing.overload
def minEnclosingConvexPolygon(
    points: cv2.typing.MatLike, k: int, polygon: cv2.typing.MatLike | None = ...
) -> tuple[float, cv2.typing.MatLike]: ...
@_typing.overload
...
def rectify3Collinear(
    ...
    P3: UMat | None = ...,
    Q: UMat | None = ...,
) -> tuple[float, UMat, UMat, UMat, UMat, UMat, UMat, UMat, cv2.typing.Rect, cv2.typing.Rect]: ...
@_typing.overload
def reduce(
    src: cv2.typing.MatLike,
    dim: int,
...
def solveP3P(
    ...
    rvecs: _typing.Sequence[cv2.typing.MatLike] | None = ...,
    tvecs: _typing.Sequence[cv2.typing.MatLike] | None = ...,
) -> tuple[int, _typing.Sequence[cv2.typing.MatLike], _typing.Sequence[cv2.typing.MatLike]]: ...
@_typing.overload
def solveP3P(
    objectPoints: UMat,
    imagePoints: UMat,
...
def solvePnPRansac(
    ...
    inliers: cv2.typing.MatLike | None = ...,
    params: UsacParams = ...,
) -> tuple[bool, cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike]: ...
@_typing.overload
def solvePnPRansac(
    objectPoints: UMat,
    imagePoints: UMat,
...
@_typing.overload
def thresholdWithMask(
    src: UMat, dst: UMat, mask: UMat, thresh: float, maxval: float, type: int
) -> tuple[float, UMat]: ...
@_typing.overload
