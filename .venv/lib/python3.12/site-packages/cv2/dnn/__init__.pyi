...
class Net:
    ...
    @_typing.overload
    def getLayersShapes(self, netInputShapes: _typing.Sequence[cv2.typing.MatShape]) -> tuple[
...
class DetectionModel(Model):
    ...
    @_typing.overload
    def detect(self, frame: cv2.UMat, confThreshold: float = ..., nmsThreshold: float = ...) -> tuple[
        _typing.Sequence[int],
        _typing.Sequence[float],
        _typing.Sequence[cv2.typing.Rect],
    ]: ...
...
def shrinkCaffeModel(
    ...
    layersTypes: _typing.Sequence[str] = ...,
) -> None: ...
def softNMSBoxes(
