...
# Functions
@_typing.overload
def copyMatAndDumpNamedArguments(
...
@_typing.overload
def copyMatAndDumpNamedArguments(
    src: cv2.UMat, dst: cv2.UMat | None = ..., lambda_: int = ..., sigma: float = ...
) -> tuple[str, cv2.UMat]: ...
...
@_typing.overload
def dumpInputOutputArray(
    argument: cv2.typing.MatLike,
) -> tuple[str, cv2.typing.MatLike]: ...
@_typing.overload
def dumpInputOutputArray(argument: cv2.UMat) -> tuple[str, cv2.UMat]: ...
@_typing.overload
def dumpInputOutputArrayOfArrays(
    argument: _typing.Sequence[cv2.typing.MatLike],
) -> tuple[str, _typing.Sequence[cv2.typing.MatLike]]: ...
@_typing.overload
def dumpInputOutputArrayOfArrays(
    argument: _typing.Sequence[cv2.UMat],
) -> tuple[str, _typing.Sequence[cv2.UMat]]: ...
...
def generateVectorOfMat(
    ...
    cols: int,
    dtype: int,
    vec: _typing.Sequence[cv2.typing.MatLike] | None = ...,
