...
class Index:
    ...
    def __init__(
        self,
        features: cv2.typing.MatLike,
        params: cv2.typing.IndexParams,
        distType: int = ...,
    ) -> None: ...
    @_typing.overload
    ...
    def knnSearch(
        self,
        query: cv2.typing.MatLike,
        knn: int,
        indices: cv2.typing.MatLike | None = ...,
        dists: cv2.typing.MatLike | None = ...,
        params: cv2.typing.SearchParams = ...,
