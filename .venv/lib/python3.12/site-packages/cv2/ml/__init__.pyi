...
class TrainData:
    ...
    def getTrainSamples(
        self, layout: int = ..., compressSamples: bool = ..., compressVars: bool = ...
    ) -> cv2.typing.MatLike: ...
    ...
    def create(
        ...
        layout: int,
        responses: cv2.typing.MatLike,
        varIdx: cv2.typing.MatLike | None = ...,
        sampleIdx: cv2.typing.MatLike | None = ...,
        sampleWeights: cv2.typing.MatLike | None = ...,
        varType: cv2.typing.MatLike | None = ...,
    ) -> TrainData: ...
    @classmethod
    @_typing.overload
    def create(
        ...
        layout: int,
        responses: cv2.UMat,
        varIdx: cv2.UMat | None = ...,
        sampleIdx: cv2.UMat | None = ...,
        sampleWeights: cv2.UMat | None = ...,
        varType: cv2.UMat | None = ...,
    ) -> TrainData: ...
...
class StatModel(cv2.Algorithm):
    ...
    @_typing.overload
    def calcError(
        self, data: TrainData, test: bool, resp: cv2.typing.MatLike | None = ...
    ...
    def predict(
        self,
        samples: cv2.typing.MatLike,
        results: cv2.typing.MatLike | None = ...,
        flags: int = ...,
    ) -> tuple[float, cv2.typing.MatLike]: ...
    @_typing.overload
    def predict(
        self, samples: cv2.UMat, results: cv2.UMat | None = ..., flags: int = ...
...
class NormalBayesClassifier(StatModel):
    ...
    def predictProb(
        self,
        inputs: cv2.typing.MatLike,
        outputs: cv2.typing.MatLike | None = ...,
        outputProbs: cv2.typing.MatLike | None = ...,
        flags: int = ...,
    ...
    def predictProb(
        self,
        inputs: cv2.UMat,
        outputs: cv2.UMat | None = ...,
        outputProbs: cv2.UMat | None = ...,
        flags: int = ...,
    ) -> tuple[float, cv2.UMat, cv2.UMat]: ...
    @classmethod
...
class KNearest(StatModel):
    ...
    def findNearest(
        ...
        k: int,
        results: cv2.typing.MatLike | None = ...,
        neighborResponses: cv2.typing.MatLike | None = ...,
        dist: cv2.typing.MatLike | None = ...,
    ) -> tuple[float, cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike]: ...
    @_typing.overload
    def findNearest(
        self,
        samples: cv2.UMat,
        k: int,
        results: cv2.UMat | None = ...,
        neighborResponses: cv2.UMat | None = ...,
        dist: cv2.UMat | None = ...,
    ) -> tuple[float, cv2.UMat, cv2.UMat, cv2.UMat]: ...
    @classmethod
...
class SVM(StatModel):
    ...
    def getDecisionFunction(
        self,
        i: int,
        alpha: cv2.typing.MatLike | None = ...,
        svidx: cv2.typing.MatLike | None = ...,
    ) -> tuple[float, cv2.typing.MatLike, cv2.typing.MatLike]: ...
    @_typing.overload
    def getDecisionFunction(
        self, i: int, alpha: cv2.UMat | None = ..., svidx: cv2.UMat | None = ...
    ) -> tuple[float, cv2.UMat, cv2.UMat]: ...
    @staticmethod
...
class EM(StatModel):
    ...
    def getCovs(
        self, covs: _typing.Sequence[cv2.typing.MatLike] | None = ...
    ...
    @_typing.overload
    def predict2(
        self, sample: cv2.typing.MatLike, probs: cv2.typing.MatLike | None = ...
    ...
    def trainEM(
        self,
        samples: cv2.typing.MatLike,
        logLikelihoods: cv2.typing.MatLike | None = ...,
        labels: cv2.typing.MatLike | None = ...,
        probs: cv2.typing.MatLike | None = ...,
    ) -> tuple[bool, cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike]: ...
    @_typing.overload
    def trainEM(
        self,
        samples: cv2.UMat,
        logLikelihoods: cv2.UMat | None = ...,
        labels: cv2.UMat | None = ...,
        probs: cv2.UMat | None = ...,
    ) -> tuple[bool, cv2.UMat, cv2.UMat, cv2.UMat]: ...
    @_typing.overload
    def trainE(
        self,
        samples: cv2.typing.MatLike,
        means0: cv2.typing.MatLike,
        covs0: cv2.typing.MatLike | None = ...,
        weights0: cv2.typing.MatLike | None = ...,
        logLikelihoods: cv2.typing.MatLike | None = ...,
        labels: cv2.typing.MatLike | None = ...,
        probs: cv2.typing.MatLike | None = ...,
    ) -> tuple[bool, cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike]: ...
