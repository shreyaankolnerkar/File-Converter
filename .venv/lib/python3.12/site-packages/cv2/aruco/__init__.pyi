...
class ArucoDetector(cv2.Algorithm):
    ...
    def __init__(
        self,
        dictionaries: _typing.Sequence[Dictionary],
        detectorParams: DetectorParameters = ...,
        refineParams: RefineParameters = ...,
    ) -> None: ...
    @_typing.overload
    ...
    @_typing.overload
    def detectMarkersWithConfidence(
        self,
        image: cv2.typing.MatLike,
        corners: _typing.Sequence[cv2.typing.MatLike] | None = ...,
        ids: cv2.typing.MatLike | None = ...,
        markersConfidence: cv2.typing.MatLike | None = ...,
        rejectedImgPoints: _typing.Sequence[cv2.typing.MatLike] | None = ...,
    ) -> tuple[
        _typing.Sequence[cv2.typing.MatLike],
        cv2.typing.MatLike,
    ...
    def detectMarkersWithConfidence(
        ...
        corners: _typing.Sequence[cv2.UMat] | None = ...,
        ids: cv2.UMat | None = ...,
        markersConfidence: cv2.UMat | None = ...,
        rejectedImgPoints: _typing.Sequence[cv2.UMat] | None = ...,
    ) -> tuple[_typing.Sequence[cv2.UMat], cv2.UMat, cv2.UMat, _typing.Sequence[cv2.UMat]]: ...
    @_typing.overload
    ...
    @_typing.overload
    def detectMarkersMultiDict(
        self,
        image: cv2.typing.MatLike,
        corners: _typing.Sequence[cv2.typing.MatLike] | None = ...,
        ids: cv2.typing.MatLike | None = ...,
        rejectedImgPoints: _typing.Sequence[cv2.typing.MatLike] | None = ...,
        dictIndices: cv2.typing.MatLike | None = ...,
    ) -> tuple[
        _typing.Sequence[cv2.typing.MatLike],
        cv2.typing.MatLike,
        _typing.Sequence[cv2.typing.MatLike],
...
class Dictionary:
    ...
    @staticmethod
    def getBitsFromByteList(
        byteList: cv2.typing.MatLike, markerSize: int, rotationId: int = ...
    ) -> cv2.typing.MatLike: ...
...
# Functions
@_typing.overload
def drawDetectedCornersCharuco(
    image: cv2.typing.MatLike,
...
def drawDetectedCornersCharuco(
    image: cv2.UMat,
    charucoCorners: cv2.UMat,
    charucoIds: cv2.UMat | None = ...,
    cornerColor: cv2.typing.Scalar = ...,
) -> cv2.UMat: ...
@_typing.overload
def drawDetectedDiamonds(
    image: cv2.typing.MatLike,
...
def drawDetectedDiamonds(
    image: cv2.UMat,
    diamondCorners: _typing.Sequence[cv2.UMat],
    diamondIds: cv2.UMat | None = ...,
    borderColor: cv2.typing.Scalar = ...,
) -> cv2.UMat: ...
@_typing.overload
...
def drawDetectedMarkers(
    image: cv2.UMat,
    corners: _typing.Sequence[cv2.UMat],
    ids: cv2.UMat | None = ...,
    borderColor: cv2.typing.Scalar = ...,
) -> cv2.UMat: ...
def extendDictionary(
    nMarkers: int,
    markerSize: int,
