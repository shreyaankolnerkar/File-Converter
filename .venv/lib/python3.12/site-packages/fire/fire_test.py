...
class FireTest(testutils.BaseTestCase):
    ...
    def testFireAllNamedArgs(self):
        ...
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["sum", "--alpha", "1", "--beta", "2"]),
            5,
        )
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["sum", "--beta", "1", "--alpha", "2"]),
            4,
        )
    ...
    def testFirePartialNamedArgs(self):
        ...
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "--alpha", "1", "2"]),
            (1, 2),
        )
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "--beta", "1", "2"]),
            (2, 1),
        )
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "1", "--alpha", "2"]),
            (2, 1),
        )
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "1", "--beta", "2"]),
            (1, 2),
        )
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "--alpha", "1", "--beta", "2"]),
            (1, 2),
        )
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "--beta", "1", "--alpha", "2"]),
            (2, 1),
        )
    ...
    def testFirePartialNamedArgsOneMissing(self):
        ...
        with self.assertRaisesFireExit(2):
            fire.Fire(tc.MixedDefaults, command=["identity"])  # Identity needs an arg.
    ...
    def testFireRecursion(self):
        self.assertEqual(
            fire.Fire(tc.TypedProperties, command=["charlie", "double", "hello"]),
            "hellohello",
        )
    ...
    def testFireVarArgs(self):
        self.assertEqual(
            fire.Fire(tc.VarArgs, command=["cumsums", "a", "b", "c", "d"]),
            ["a", "ab", "abc", "abcd"],
        )
        self.assertEqual(
    ...
    def testFireKeywordArgs(self):
        self.assertEqual(
            fire.Fire(tc.Kwargs, command=["props", "--name", "David", "--age", "24"]),
            {"name": "David", "age": 24},
        )
        ...
        self.assertEqual(
            fire.Fire(tc.Kwargs, command='props --message "This is a message it has -- in it"'),
            {"message": "This is a message it has -- in it"},
        )
        self.assertEqual(
            fire.Fire(tc.Kwargs, command=["upper", "--alpha", "A", "--beta", "B"]),
            "ALPHA BETA",
        )
        self.assertEqual(
            fire.Fire(
    ...
    def testFireUnderscoresInArg(self):
        self.assertEqual(
            fire.Fire(tc.Underscores, command=["underscore-function", "example"]),
            "example",
        )
        self.assertEqual(
            fire.Fire(
    ...
    def testBoolParsingContinued(self):
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "True", "False"]),
            (True, False),
        )
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "--alpha=False", "10"]),
            (False, 10),
        )
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "--alpha", "--beta", "10"]),
            (True, 10),
        )
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "--alpha", "--beta=10"]),
        ...
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "--noalpha", "--beta"]),
            (False, True),
        )
        self.assertEqual(
    ...
    def testBoolParsingSingleHyphen(self):
        ...
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "-alpha", "-10", "-beta"]),
            (-10, True),
        )
    ...
    def testBoolParsingLessExpectedCases(self):
        ...
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "--alpha", "10"]),
            (10, "0"),
        )
        ...
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "--alpha", "True", '"--test"']),
            (True, "--test"),
        )
    ...
    def testSingleCharFlagParsing(self):
        ...
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "-a", "--beta=10"]),
            (True, 10),
        )
        self.assertEqual(fire.Fire(tc.MixedDefaults, command=["identity", "-a", "-b"]), (True, True))
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "-a", "42", "-b"]),
            (42, True),
        )
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "-a", "42", "-b", "10"]),
            (42, 10),
        )
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "--alpha", "True", "-b", "10"]),
            (True, 10),
        )
        with self.assertRaisesFireExit(2):
    ...
    def testSingleCharFlagParsingEqualSign(self):
        ...
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "-a=3", "--beta=10"]),
            (3, 10),
        )
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "-a=False", "-b=15"]),
            (False, 15),
        )
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "-a", "42", "-b=12"]),
            (42, 12),
        )
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "-a=42", "-b", "10"]),
    ...
    def testSingleCharFlagParsingExactMatch(self):
        ...
        self.assertEqual(
            fire.Fire(tc.SimilarArgNames, command=["identity2", "-a", "-alpha"]),
            (True, True),
        )

    def testSingleCharFlagParsingCapitalLetter(self):
        self.assertEqual(
            fire.Fire(tc.CapitalizedArgNames, command=["sum", "-D", "5", "-G", "10"]),
            15,
        )
    ...
    def testBoolParsingWithNo(self):
        ...
        self.assertEqual(
            fire.Fire(fn2, command=["--nothing", "--nothing=True"]),
            (False, {"nothing": True}),
        )
        ...
        self.assertEqual(
            fire.Fire(fn3, command=["--arg=value", "--thing"]),
            ("value", {"thing": True}),
        )
        self.assertEqual(
            fire.Fire(fn3, command=["--arg=value", "--nothing"]),
            ("value", {"thing": False}),
        )
        self.assertEqual(
            fire.Fire(fn3, command=["--arg=value", "--nonothing"]),
            ("value", {"nothing": False}),
        )
    ...
    def testSeparatorForChaining(self):
        ...
        self.assertIsInstance(
            fire.Fire(tc.ReturnsObj, command=["get-obj", "arg1", "arg2", "as-bool", "True"]),
            tc.BoolConverter,
        )
    ...
    def testNegativeNumbers(self):
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["sum", "--alpha", "-3", "--beta", "-4"]),
            -11,
        )

    def testFloatForExpectedInt(self):
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["sum", "--alpha", "2.2", "--beta", "3.0"]),
            8.2,
        )
        self.assertEqual(
            fire.Fire(tc.NumberDefaults, command=["integer_reciprocal", "--divisor", "5.0"]),
            0.2,
        )
