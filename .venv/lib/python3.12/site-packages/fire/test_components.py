...
from fire import (
    test_components_py3 as py3,  # pylint: disable=unused-import,no-name-in-module,g-import-not-at-top
)
...
class WithDefaults:
    ...
    def text(
        self,
        string=("0001020304050607080910111213141516171819" "2021222324252627282930313233343536373839"),
    ):
        return string
