...
class LigatureSubstBuilder(LookupBuilder):
    ...
    def getAlternateGlyphs(self):
        ...
        return {components[0]: [ligature] for components, ligature in self.ligatures.items() if len(components) == 1}
...
class MultipleSubstBuilder(LookupBuilder):
    ...
    def getAlternateGlyphs(self):
        # https://github.com/fonttools/fonttools/issues/3845
        return {glyph: replacements for glyph, replacements in self.mapping.items() if len(replacements) == 1}
...
class AnySubstBuilder(LookupBuilder):
    ...
    def getAlternateGlyphs(self):
        return {key[0]: value for key, value in self.mapping.items() if len(key) == 1 and len(value) == 1}
