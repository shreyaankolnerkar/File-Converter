...
def is_Default_Ignorable(u):
    ...
    return (
        ...
        or u == 0x180E  # Mn   [3] MONGOLIAN FREE VARIATION SELECTOR ONE..MONGOLIAN FREE VARIATION SELECTOR THREE
        ...
        or 0x1D173 <= u <= 0x1D17A  # Cf   [4] SHORTHAND FORMAT LETTER OVERLAP..SHORTHAND FORMAT UP STEP
