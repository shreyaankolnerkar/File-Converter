...
otTables.GDEF.mergeMap = otTables.GSUB.mergeMap = otTables.GPOS.mergeMap = otTables.BASE.mergeMap = (
...
ttLib.getTableClass("GDEF").mergeMap = ttLib.getTableClass("GSUB").mergeMap = ttLib.getTableClass("GPOS").mergeMap = (
    ttLib.getTableClass("BASE").mergeMap
) = ttLib.getTableClass("JSTF").mergeMap = ttLib.getTableClass("MATH").mergeMap = {
