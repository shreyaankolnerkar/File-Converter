    ...
    def normalize(self, varfont, usingAvar=True) -> "NormalizedAxisLimits":
        ...
        if usingAvar and "avar" in varfont:
            ...
            if getattr(avar, "majorVersion", 1) >= 2 and avar.table.VarStore:
                ...
                location = {tag: normalize(value, axes[tag], None) for tag, value in location.items()}
                return NormalizedAxisLimits(**avar.renormalizeLocation(location, varfont, dropZeroes=False))
