...
class UFOReader(_UFOBaseIO):
    ...
    def getReadFileForPath(self, path: PathStr, encoding: Optional[str] = None) -> Optional[Union[IO[bytes], IO[str]]]:
        """
    ...
    def getKerningGroupConversionRenameMaps(self, validate: Optional[bool] = None) -> KerningGroupRenameMaps:
        """
...
class UFOWriter(UFOReader):
    ...
    def writeLayerContents(self, layerOrder: LayerOrderList = None, validate: Optional[bool] = None) -> None:
        """
        ...
        layerContents = [
            (layerName, self.layerContents[layerName]) for layerName in layerOrder if layerName is not None
        ]
...
fontInfoAttributesVersion3ValueData: FontInfoAttributes = deepcopy(fontInfoAttributesVersion2ValueData)
...
def convertFontInfoValueForAttributeFromVersion2ToVersion3(attr: str, value: Any) -> tuple[str, Any]:
    """
...
def convertFontInfoValueForAttributeFromVersion3ToVersion2(attr: str, value: Any) -> tuple[str, Any]:
    """
