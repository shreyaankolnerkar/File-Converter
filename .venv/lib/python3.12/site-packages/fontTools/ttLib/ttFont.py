...
from fontTools.ttLib.ttGlyphSet import _TTGlyph  # noqa: F401
...
class TTFont(object):
    ...
    def _saveXML(
        ...
        if not splitTables:
            ...
            if writer.filename is None:
                raise TTLibError("splitTables requires the file name to be a file system path, not a stream.")
    ...
    def get(self, tag: str | bytes, default: Any | None = None) -> DefaultTable | GlyphOrder | Any | None:
