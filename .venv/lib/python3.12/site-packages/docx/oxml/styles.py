...
class CT_Style(BaseOxmlElement):
    ...
    type: WD_STYLE_TYPE | None = OptionalAttribute("w:type", WD_STYLE_TYPE)  # pyright: ignore[reportAssignmentType]
    styleId: str | None = OptionalAttribute("w:styleId", ST_String)  # pyright: ignore[reportAssignmentType]
