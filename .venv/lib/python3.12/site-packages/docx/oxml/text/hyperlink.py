...
class CT_Hyperlink(BaseOxmlElement):
    ...
    anchor: str | None = OptionalAttribute("w:anchor", ST_String)  # pyright: ignore[reportAssignmentType]
    history: bool = OptionalAttribute("w:history", ST_OnOff, default=True)  # pyright: ignore[reportAssignmentType]
