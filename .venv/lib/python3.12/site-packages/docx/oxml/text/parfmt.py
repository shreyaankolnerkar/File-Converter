...
class CT_Ind(BaseOxmlElement):
    ...
    left: Length | None = OptionalAttribute("w:left", ST_SignedTwipsMeasure)  # pyright: ignore[reportAssignmentType]
    right: Length | None = OptionalAttribute("w:right", ST_SignedTwipsMeasure)  # pyright: ignore[reportAssignmentType]
    firstLine: Length | None = OptionalAttribute(  # pyright: ignore[reportAssignmentType]
        "w:firstLine", ST_TwipsMeasure
    )
    hanging: Length | None = OptionalAttribute("w:hanging", ST_TwipsMeasure)  # pyright: ignore[reportAssignmentType]


class CT_Jc(BaseOxmlElement):
    """``<w:jc>`` element, specifying paragraph justification."""

    val: WD_ALIGN_PARAGRAPH = RequiredAttribute("w:val", WD_ALIGN_PARAGRAPH)  # pyright: ignore[reportAssignmentType]
...
class CT_PPr(BaseOxmlElement):
    ...
    pStyle: CT_String | None = ZeroOrOne("w:pStyle", successors=_tag_seq[1:])  # pyright: ignore[reportAssignmentType]
    ...
    ind: CT_Ind | None = ZeroOrOne("w:ind", successors=_tag_seq[23:])  # pyright: ignore[reportAssignmentType]
...
class CT_TabStop(BaseOxmlElement):
    ...
    val: WD_TAB_ALIGNMENT = RequiredAttribute("w:val", WD_TAB_ALIGNMENT)  # pyright: ignore[reportAssignmentType]
    ...
    pos: Length = RequiredAttribute("w:pos", ST_SignedTwipsMeasure)  # pyright: ignore[reportAssignmentType]
