...
class CT_LastRenderedPageBreak(BaseOxmlElement):
    ...
    def following_fragment_p(self) -> CT_P:
        ...
        return self._following_frag_in_hlink if self._is_in_hyperlink else self._following_frag_in_run
    ...
    def preceding_fragment_p(self) -> CT_P:
        ...
        # -- splitting approach is different when break is inside a hyperlink --
        return self._preceding_frag_in_hlink if self._is_in_hyperlink else self._preceding_frag_in_run
