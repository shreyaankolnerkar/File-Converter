...
class CT_Blip(BaseOxmlElement):
    ...
    embed: str | None = OptionalAttribute("r:embed", ST_RelationshipId)  # pyright: ignore[reportAssignmentType]
    link: str | None = OptionalAttribute("r:link", ST_RelationshipId)  # pyright: ignore[reportAssignmentType]
...
class CT_GraphicalObject(BaseOxmlElement):
    ...
    graphicData: CT_GraphicalObjectData = OneAndOnlyOne("a:graphicData")  # pyright: ignore[reportAssignmentType]
...
class CT_Inline(BaseOxmlElement):
    ...
    docPr: CT_NonVisualDrawingProps = OneAndOnlyOne("wp:docPr")  # pyright: ignore[reportAssignmentType]
    graphic: CT_GraphicalObject = OneAndOnlyOne("a:graphic")  # pyright: ignore[reportAssignmentType]
...
class CT_Picture(BaseOxmlElement):
    ...
    nvPicPr: CT_PictureNonVisual = OneAndOnlyOne("pic:nvPicPr")  # pyright: ignore[reportAssignmentType]
    blipFill: CT_BlipFillProperties = OneAndOnlyOne("pic:blipFill")  # pyright: ignore[reportAssignmentType]
...
class CT_PositiveSize2D(BaseOxmlElement):
    ...
    cx: Length = RequiredAttribute("cx", ST_PositiveCoordinate)  # pyright: ignore[reportAssignmentType]
    cy: Length = RequiredAttribute("cy", ST_PositiveCoordinate)  # pyright: ignore[reportAssignmentType]
