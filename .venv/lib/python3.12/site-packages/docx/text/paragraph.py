...
class Paragraph(StoryChild):
    ...
    def insert_paragraph_before(self, text: str | None = None, style: str | ParagraphStyle | None = None) -> Paragraph:
    ...
    def iter_inner_content(self) -> Iterator[Run | Hyperlink]:
        ...
        for r_or_hlink in self._p.inner_content_elements:
            yield (Run(r_or_hlink, self) if isinstance(r_or_hlink, CT_R) else Hyperlink(r_or_hlink, self))
