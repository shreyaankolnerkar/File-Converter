...
class Relationships(Dict[str, "_Relationship"]):
    ...
    def _get_matching(self, reltype: str, target: Part | str, is_external: bool = False) -> _Relationship | None:
...
class _Relationship:
    ...
    def target_part(self) -> Part:
        if self._is_external:
            raise ValueError("target_part property on _Relationship is undefined when target mode is External")
